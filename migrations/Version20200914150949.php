 ...
 */
final class Version20200914150949 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(120) NOT NULL, siret VARCHAR(14) DEFAULT NULL, address1 VARCHAR(80) DEFAULT NULL, address2 VARCHAR(80) DEFAULT NULL, city VARCHAR(80) DEFAULT NULL, zip_code VARCHAR(10) DEFAULT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
